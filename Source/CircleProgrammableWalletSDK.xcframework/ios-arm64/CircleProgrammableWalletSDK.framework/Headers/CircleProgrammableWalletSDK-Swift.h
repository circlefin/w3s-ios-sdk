...
#ifndef CIRCLEPROGRAMMABLEWALLETSDK_SWIFT_H
#define CIRCLEPROGRAMMABLEWALLETSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CircleProgrammableWalletSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC27CircleProgrammableWalletSDK26BasePINInputViewController")
@interface BasePINInputViewController : BaseViewController
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
...
@interface BasePINInputViewController (SWIFT_EXTENSION(CircleProgrammableWalletSDK)) <UITextFieldDelegate>
...
@interface ConfirmPINCodeViewController (SWIFT_EXTENSION(CircleProgrammableWalletSDK))
- (void)textFieldDidChange:(UITextField * _Nonnull)textField;
@end
...
SWIFT_CLASS("_TtC27CircleProgrammableWalletSDK14InputTextField")
@interface InputTextField : PaddedTextField
...
@interface NewPINCodeViewController (SWIFT_EXTENSION(CircleProgrammableWalletSDK))
- (void)textFieldDidChange:(UITextField * _Nonnull)textField;
@end
...
@interface SecurityConfirmViewController (SWIFT_EXTENSION(CircleProgrammableWalletSDK)) <UITextFieldDelegate>
- (void)textFieldDidBeginEditing:(UITextField * _Nonnull)textField;
- (void)textFieldDidEndEditing:(UITextField * _Nonnull)textField reason:(UITextFieldDidEndEditingReason)reason;
@end
...
SWIFT_CLASS("_TtC27CircleProgrammableWalletSDK29SecurityQuestionTableViewCell")
@interface SecurityQuestionTableViewCell : UITableViewCell
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
@end


@interface SecurityQuestionTableViewCell (SWIFT_EXTENSION(CircleProgrammableWalletSDK)) <UITextFieldDelegate>
- (void)textFieldDidBeginEditing:(UITextField * _Nonnull)textField;
- (void)textFieldDidEndEditing:(UITextField * _Nonnull)textField reason:(UITextFieldDidEndEditingReason)reason;
@end
...
@interface SecuritySummaryViewController (SWIFT_EXTENSION(CircleProgrammableWalletSDK)) <UITableViewDataSource>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC27CircleProgrammableWalletSDK27SelectQuestionTableViewCell")
@interface SelectQuestionTableViewCell : UITableViewCell
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier SWIFT_UNAVAILABLE;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
@end
